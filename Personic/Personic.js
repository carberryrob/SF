...
$(window).load(function () {
    ...
    $('head').append('<link href="https://fonts.googleapis.com/css2?family=Fjalla+One&family=Montserrat:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&family=Work+Sans:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap" rel="stylesheet"></link>');
    $('head').append('<link rel="dns-prefetch" href="//fonts.googleapis.com" />');
    $('head').append('<link href="https://fonts.gstatic.com" crossorigin rel="preconnect" />');


    $('head').append('<link rel="icon" href="con/cropped-Personic-Health-Logo-32x32.png" sizes="32x32" />');
    $('head').append('<link rel="icon" href="con/cropped-Personic-Health-Logo-192x192.png" sizes="192x192" />');
    $('head').append('<link rel="apple-touch-icon" href="con/cropped-Personic-Health-Logo-180x180.png" />');
	...
	if($(window).width() >= 1025) {
		...
		// $( "#logout_userid" ).insertBefore( '#dropicon' );
		$( "#logout_userid" ).insertBefore( '.dropdown' );
        $( "#logout_userid" ).wrap('<div id="myaccount" class="myaccountdiv"></div>');
        $('#myaccount').append($('#dropdowndiv'));
	...
	$("div#TabsDiv").delay(300).fadeIn(300);
	// $("div#TabsDiv").show();
