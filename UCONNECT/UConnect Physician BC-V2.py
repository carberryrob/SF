...
if Physician_List == '-None':
     ...
     if Physician_List != '-None':
          ...
          F2, IFSET(Phone3Word, 'Fax'), F8, IFSET(Phone3Word, ' '), F1, Phone3Word, NEWLINE], (1.94*72, 144), (LEFT, TOP), (1.4*72,0), layer=0)
     ...
     if card2_address != '-None':
          ...
          ### Create office and fax numbers.
          Phn2Block = DWIMBLOCK([LEFT, F2, IFSET(card2_phone, 'Office'), F8, IFSET(card2_phone, ' '), F1, card2_phone, NEWLINE,
          F2, IFSET(card2_fax, 'Fax'), F8, IFSET(card2_fax, ' '), F1, card2_fax, NEWLINE], (1.94*72, 144), (LEFT, TOP), (1.4*72,0), layer=0)
          bloks.append(Phn2Block)
     ...
     if card3_address != '-None':
          ...
          ### Create office and fax numbers.
          Phn3Block = DWIMBLOCK([LEFT, F2, IFSET(card3_phone, 'Office'), F8, IFSET(card3_phone, ' '), F1, card3_phone, NEWLINE,
          F2, IFSET(card3_fax, 'Fax'), F8, IFSET(card3_fax, ' '), F1, card3_fax, NEWLINE], (1.94*72, 144), (LEFT, TOP), (1.4*72,0), layer=0)
          bloks.append(Phn3Block)
     ...
     top = (height-147)/2
     DocBlock.move(0, top)
     moveby = (147-DocBlock._get_bottom() + vspc) * -1
     Add1Block.move( 0, moveby )
     moveby = (147-Add1Block._get_bottom() + (vspc/2)) * -1
     # moveby = (147-Add1Block._get_bottom() + vspc) * -1
     PhnBlock.move( 0, moveby )
     moveby = (147-PhnBlock._get_bottom() + vspc) * -1
     if card2_address != '-None':
          Add2Block.move( 0, moveby )
          moveby = (147-Add2Block._get_bottom() + (vspc/2)) * -1
          # moveby = (147-Add2Block._get_bottom() + vspc) * -1
          Phn2Block.move( 0, moveby )
          moveby = (147-Phn2Block._get_bottom() + vspc) * -1
     if card3_address != '-None':
          Add3Block.move( 0, moveby )
          moveby = (147-Add3Block._get_bottom() + (vspc/2)) * -1
          # moveby = (147-Add3Block._get_bottom() + vspc) * -1
          Phn3Block.move( 0, moveby )
          # moveby = (146.40625-Phn3Block._get_bottom() + vspc) * -1
     # PhnBlock.move( 0, moveby )
