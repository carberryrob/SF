...
if (cnt == 1):  ### For 1 address we don't use the check boxes.
     ...
     if card_address != '-None':
          add1 = DWIMLINES([LEFT, F1, COL, card_center, NEWLINE,
          COL, card_street1, NEWLINE,
     ...
     if card2_address != '-None':
          add2 = DWIMLINES([LEFT, F1, COL, card2_center, NEWLINE,
          COL, card2_street1, NEWLINE,
     ...
     if card3_address != '-None':
          add3 = DWIMLINES([LEFT, F1, COL, card3_center, NEWLINE,
          COL, card3_street1, NEWLINE,
     ...
     if card4_address != '-None':
          add4 = DWIMLINES([LEFT, F1, COL, card4_center, NEWLINE,
          COL, card4_street1, NEWLINE,
     ...
     if card5_address != '-None':
          add5 = DWIMLINES([LEFT, F1, COL, card5_center, NEWLINE,
          COL, card5_street1, NEWLINE,
     ...
     if card6_address != '-None':
          add6 = DWIMLINES([LEFT, F1, COL, card6_center, NEWLINE,
          COL, card6_street1, NEWLINE,
