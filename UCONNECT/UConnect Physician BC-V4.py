...
if Physician_List == '-None':
     ...
     if card2_address != '-None':
          if card2_address not in addused:
               cnt += 1
               addused.append(address)
          else:
               COND('The address for ' + card2_address.upper() + ' is already selected.  Only unique addresses can be added to the envelope.')
     address = None
