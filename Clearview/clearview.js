...
$(window).load(function () {
     ...
     if($(window).width() >= 1025) {
          ...
          // If div.the_actual_qty_select exist set that area height the same for all items
          span.responsive-tagcheck.tagcheck-bottom
          $('span.responsive-tagcheck.tagcheck-bottom:not(:has(>div.the_actual_qty_select)').append('<div class="the_actual_qty_select"></div>');
          maxH = 0;
          $("div.the_actual_qty_select").each(function() {
               if ($(this).height() > maxH) {
                    maxH = $(this).height();
               }
          });
