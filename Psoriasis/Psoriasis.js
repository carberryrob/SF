...
$(window).load(function () {
     ...
     $('head').append('<link rel="icon" href="con/favicon.png" sizes="192x192" />')
     $('head').append('<link rel="apple-touch-icon" href="con/favicon.png" />')

     $('head').append('<link rel="stylesheet" href="https://use.typekit.net/bry6abl.css">');
