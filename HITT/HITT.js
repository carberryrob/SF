...
$(window).load(function () {
     ...
     $('head').append('<link rel="icon" href="con/cropped-HITT-Favicon_White-Background-1-1-32x32.png" sizes="32x32" />');
     $('head').append('<link rel="icon" href="con/cropped-HITT-Favicon_White-Background-1-1-192x192.png" sizes="192x192" />');
     $('head').append('<link rel="apple-touch-icon" href="con/cropped-HITT-Favicon_White-Background-1-1-180x180.png" />');
     $('head').append('<meta name="msapplication-TileImage" content="con/cropped-HITT-Favicon_White-Background-1-1-270x270.png" />');
...
$(document).ready(function () {
     ...
     // $( "#header_logo img.no_mobile" ).wrap( '<td id="desklogo"><div class="logolinkdiv"><a style="display: inline-block;" href="index.cgi">' );
     $( "#header_logo img.no_mobile" ).wrap( '<div id="desklogo"><div class="logolinkdiv"><a style="display: inline-block;" href="index.cgi">' );
     $( "#header_logo img.no_desktop" ).wrap( '<a style="display: inline-block;" href="index.cgi">' );
     ...
     if ($(window).width() >= 1025) {
          ...
          $( "a[href='basket_view.cgi'].no_mobile" ).insertAfter( "#dropdowndiv" );
          ...
          $( "#logout_userid" ).insertBefore( '#dropdowndiv' );
          
          $( "div#desklogo" ).insertBefore("#logout_userid");
          ...
          $("div#Srch").insertBefore( "div#desklogo" );
          $("span.cart_num_items.no_mobile").parent("a").wrap('<div class="carticon">');
          $("div.carticon").insertBefore( "div#desklogo" );

          if ($("div#Srch").length > 0 && $("div.carticon").length > 0) {
               $('.header-links div').slice(0, 2).wrapAll('<td id="left-header-links" class="left middle">');
          } else if ($("div#Srch").length > 0 && $("div.carticon").length == 0) {
               $('.header-links div').slice(0, 1).wrapAll('<td id="left-header-links" class="left middle">');
          } else if ($("div#Srch").length == 0 && $("div.carticon").length > 0) {
               $('.header-links div').slice(0, 1).wrapAll('<td id="left-header-links" class="left middle">');
          } else {
               $('<td id="left-header-links" class="left middle">&nbsp;</td>').insertBefore('#desklogo')
          }
          
          $('#left-header-links').insertBefore('.header-links');
          $('.header-links div').slice(0, 1).wrapAll('<td id="center-header-links" class="center middle">');
          $('#center-header-links').insertBefore('.header-links');
          $('.header-links').attr('id', 'right-header-links').addClass('right').addClass('middle').removeClass('header-links');
