...
if layout == '3-wide':
	if center_text == "No":
		PersonBloc = DWIMBLOCK([LEFT, F1, IF(name_prefix, ' '), name_first, ' ', IF(name_middle, ' '), name_last, IF(', ', name_suffix), NEWLINE, F3, card_rank, NEWLINE, card_expertise, NEWLINE, card_expertise2, NEWLINE], (0.125*72, (2-0.7492)*72), (LEFT, TOP_BASELINE), (3*72, 0))
	else:
		PersonBloc = DWIMBLOCK([CENTER, F1, IF(name_prefix, ' '), name_first, ' ', IF(name_middle, ' '), name_last, IF(', ', name_suffix), NEWLINE, F3, card_rank, NEWLINE, card_expertise, NEWLINE, card_expertise2, NEWLINE], (1.75*72, (2-0.7492)*72), (CENTER, TOP_BASELINE), (3*72, 0))
	...
	if center_text == "No":
		PersonBloc = DWIMBLOCK([LEFT, F1, IF(name_prefix, ' '), name_first, ' ', IF(name_middle, ' '), name_last, IF(', ', name_suffix), NEWLINE, F3, card_rank, NEWLINE, card_expertise, NEWLINE, card_expertise2, NEWLINE], (0.25*72, (2-0.7909)*72), (LEFT, TOP_BASELINE), (3*72, 0))
	else:
		PersonBloc = DWIMBLOCK([CENTER, F1, IF(name_prefix, ' '), name_first, ' ', IF(name_middle, ' '), name_last, IF(', ', name_suffix), NEWLINE, F3, card_rank, NEWLINE, card_expertise, NEWLINE, card_expertise2, NEWLINE], (1.75*72, (2-0.7909)*72), (CENTER, TOP_BASELINE), (3*72, 0))
	...
	if center_text == "No":
		PersonBloc = DWIMBLOCK([LEFT, F1, IF(name_prefix, ' '), name_first, ' ', IF(name_middle, ' '), name_last, IF(', ', name_suffix), NEWLINE, F3, card_rank, NEWLINE, card_expertise, NEWLINE, card_expertise2, NEWLINE], (0.2071*72, (2-0.8603)*72), (LEFT, TOP_BASELINE), (3*72, 0))
	else:
		PersonBloc = DWIMBLOCK([CENTER, F1, IF(name_prefix, ' '), name_first, ' ', IF(name_middle, ' '), name_last, IF(', ', name_suffix), NEWLINE, F3, card_rank, NEWLINE, card_expertise, NEWLINE, card_expertise2, NEWLINE], (1.75*72, (2-0.8603)*72), (CENTER, TOP_BASELINE), (3*72, 0))
