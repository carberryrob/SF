...
card_title3, NEWLINE,
IFSET(Phone1Word or Phone2Word, VSPACER(vspc)), IFSET(Phone1Word, ['O: ', COL, Phone1Word]), NEWLINE,
IFSET(Phone2Word, ['D: ', COL, Phone2Word]), NEWLINE,
IFSET(card_email or LinkedIn, VSPACER(vspc)), card_email, NEWLINE,
LinkedIn, NEWLINE,
VSPACER(vspc), F8, 'www.dilldinkers.com', NEWLINE,
VSPACER(vspc), F9, 'Each franchise independently owned & operated', NEWLINE],[], (1.95*72,1.625*72))
